...
class TurfSubmittingState extends AddTurfState {}

class TurfSubmitSuccessState extends AddTurfState {}

class TurfSubmitErrorState extends AddTurfState {
  final String error;
  TurfSubmitErrorState({required this.error});
